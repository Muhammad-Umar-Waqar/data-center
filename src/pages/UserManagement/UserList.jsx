...
//   const { list: Users, loading: isLoading } = useSelector((state) => state.User);
...
//                             handleToggleStatus(u);
//                           }}
//                           className={`inline-block px-1.5 md:px-3 py-1 rounded text-xs font-semibold focus:outline-none ${u.isActive
//                             ? "bg-green-100 text-green-800 border border-green-300"
//                             : "bg-red-100 text-red-800 border border-red-300"
//                             }`}
//                           title={u.isActive ? "Click to suspend" : "Click to activate"}
...
//                           className="cursor-pointer user-action-btn rounded-full border border-red-500/50 bg-white flex items-center justify-center hover:bg-red-50 w-8 h-8"
//                         >
//                           <Trash className="text-red-600 user-action-icon " size={16} />
//                         </button>
...
//         itemName={selectedUserToDelete?.name || selectedUserToDelete?.email || ""}
//         itemLabel="User"
//         itemId={selectedUserToDelete?._id}
//       />
...
//         open={deleteOpen}
//         handleClose={handleDeleteClose}
//         // handleDelete={() => handleDelete(selectedUserToDelete?._id)}
//         handleDelete={handleDelete}
//         itemName={selectedUserToDelete?.name || selectedUserToDelete?.email || ""}
//         itemLabel="User"
//         itemId={selectedUserToDelete?._id}
