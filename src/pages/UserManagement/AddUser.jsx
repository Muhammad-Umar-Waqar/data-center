...
// import "../../styles/pages/management-pages.css";
// import Swal from "sweetalert2";
// import { FormControl, Select, MenuItem, Checkbox, ListItemText, Autocomplete, TextField } from "@mui/material";

// const AddUser = () => {
//   const dispatch = useDispatch();
//   // const { currentUser } = useSelector((s) => s.users;);
//   const { currentUser } = useSelector((s) => s.User);
//   const { DataCenters = [], isLoading } = useSelector((s) => s.DataCenter || {});
...
//     if (currentUser?.role === "manager" && formData.dataCenters.length === 0) {
//       return Swal.fire({
//         icon: "error",
...
//       if (currentUser?.role === "manager") {
//         payload.dataCenters = formData.dataCenters;
//       }
...
//     return null; // users cannot create users
//   }
...
//             className={`mt-6 bg-blue-600 text-white px-6 py-2 rounded-md w-full cursor-pointer ${
